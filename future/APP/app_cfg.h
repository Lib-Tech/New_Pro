...
#define  APP_TASK_START_PRIO                               2	//负责读取传感器
#define  APP_TASK_USER_IF_PRIO                             13
#define  APP_TASK_KBD_PRIO                                 12
#define  Task_Com1_PRIO                                    4	
#define  Task_Led1_PRIO                                    7	//负责计算Q无数
#define  Task_Led2_PRIO                                    8	//负责计算姿态
#define  Task_Led3_PRIO                                    9	//负责显示
...
#define	 Task_DAC_SPI_STK_SIZE							 128
#define	 Task_Key_SCAN_STK_SIZE							 128
